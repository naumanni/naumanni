...
export const messages = {
  ...
  'column.menu.clear_notifications': '通知を消去する',
  'column.menu.close': 'カラムを閉じる',
  'column.menu.confirm.clear_notifications': '本当に通知を消去しますか？',
  ...
  'toot_form.label.progress': 'トゥートをポスト中...',
  ...
  'toot_form.note.posting_media_files': '{n}つ目のメディアをアップロード中...',
  'toot_form.note.posting_toot': 'トゥートをポスト中...',
