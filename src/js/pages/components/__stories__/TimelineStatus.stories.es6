...
const PUBLIC_STATUS = new Status({
  ...
  "reblogs_count":0,"favourites_count":0,"reblog":null,"favourited":null,"reblogged":null
})
...
const DIRECT_W_REPLY_STATUS = new Status({
  ...
  "media_attachments":[],"mentions":[],"tags":[],"uri":"tag:oppai.tokyo,2017-05-06:objectId=8166:objectType=Status","content":"<p>非収録StatusにDM返信</p>","url":"https://oppai.tokyo/@shn/8166","reblogs_count":0,"favourites_count":0,"reblog":null,"favourited":null,"reblogged":null
})
